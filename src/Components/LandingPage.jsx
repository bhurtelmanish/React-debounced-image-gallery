  ...
  return (
    <div className='flex  flex-col h-auto dark:bg-[var(--darkBackground)] dark:text-[var(--lightColor)] z-[-1] pt-6 px-4 flex'>
      <div className='flex flex-col md:justify-center md:items-center'>
        <header className='font-extrabold md:mt-5  md:text-[3.5rem] text-[2.6rem] text-[var(--themeColor)]'><span className='text-[var(--blueColor)]'>Pixabay</span> Image Gallery</header>
